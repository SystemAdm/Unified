...
const submit = () => {
    if (selectedUserId.value) {
        ...
        // Inertia POST request to send reset link
        form.post(route('password.send-reset-for-user', { email_id: props.email_id }));
    }
};
...
<template>
    <AuthLayout :title="trans('Choose an Account')" :description="trans('Multiple accounts are associated with the email')">
        ...
        <div class="space-y-6">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="mt-6">
                    <Button type="submit" class="w-full" :disabled="!selectedUserId || form.processing">
