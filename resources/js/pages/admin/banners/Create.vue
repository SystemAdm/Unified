...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Add', href: route('admin.banners.create') },
];
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex flex-col space-y-6">
            <HeadingSmall title="Add Banner" description="Add a new banner to the system" />
            <form @submit.prevent="submit" class="max-w-2xl space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <Button type="submit" :disabled="form.processing"><SaveIcon />Add Banner</Button>
                </div>
            </form>
        </div>
    </AppLayout>
