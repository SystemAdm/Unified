...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.announcement.title, href: route('admin.announcements.edit', { announcement: props.announcement.id }) },
];
...
const form = useForm({
    ...
    from_datetime: formatDateTimeForInput(props.announcement.from_datetime),
    to_datetime: formatDateTimeForInput(props.announcement.to_datetime),
    is_published: props.announcement.is_published,
    visible_to_access: props.announcement.visible_to_access || [],
    visible_to_role: props.announcement.visible_to_role || [],
    _method: 'PUT',
});

const submit = () => {
    form.post(route('admin.announcements.update', { announcement: props.announcement.id }), {
        onSuccess: () => {
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex flex-col space-y-6">
            <HeadingSmall title="Edit Announcement" description="Update announcement information" />
            <form @submit.prevent="submit" class="max-w-2xl space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <Button type="submit" :disabled="form.processing"><SaveIcon />Update Announcement</Button>
                </div>
            </form>
        </div>
    </AppLayout>
